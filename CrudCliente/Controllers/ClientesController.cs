...
namespace CrudCliente.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,Email,Endereco,Contato")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,Email,Endereco,Contato")] Cliente cliente)
        {
            if (id != cliente.ID)
            {
                return NotFound();
